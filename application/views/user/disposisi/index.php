        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="#hapusjsurat<?php echo $id_disposisi; ?>" class="badge badge-danger" data-toggle="modal">Hapus</a>
                    </td>
                </tr>

                <!-- Menghapus Jenis Surat-->
                <div class="modal fade" id="hapusjsurat<?php echo $id_disposisi; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
